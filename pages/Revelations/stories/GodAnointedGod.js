...
export default function GodAnointedGod({ navigation })
{
    ...
    return (
        <>
            ...
            <Text style={styles.normal}>While growing up I heard sayings like “I’ll always be a sinner.” or “Well, we can’t be like that, He is Jesus.”. If we believe those statements then we are doing God a great disservice and missing the Gospel all together. The Lord said “Be holy, because I am holy.” 1 Peter 1:16. He would not say that if it wasn’t possible, but it is only by the power of Holy Spirit that we are able to become like Him.</Text>
