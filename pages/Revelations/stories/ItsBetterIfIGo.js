    ...
    return (
        <>
            <Text style={styles.capital}>W
                <Text style={styles.normal}>hen Mary (not the mother of Jesus) was at the tomb of Jesus early in the morning and while it was still dark outside. She was weeping because Jesus’s body was missing from the tomb. Jesus then revealed Himself to her at that moment and she went to wrap herself around Him. Jesus said to her, “Stop clinging to Me, for I have not yet ascended to the Father, but go to My brethren and say to them, ‘I ascend to My Father and your Father, and My God and your God.’” John 20:17. </Text>
            </Text>
            <Text style={styles.normal}>For Jesus to say “My Father and your Father, and My God and your God.”  is a huge deal now and back then especially in their culture because there was no way that God could be their Father. Also why would Jesus tell one of His own that had been following Him for years to stop trying to touch Him because He had not yet ascended to the Father? What does ascending to the Father have to do with it? The answer is in a few chapters back that Mary was not remembering in this divine encounter with the risen One. </Text>
