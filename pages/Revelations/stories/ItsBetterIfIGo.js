...
export default function ItsBetterIfIGo({ navigation })
{
    ...
    return (
        <>
            ...
            <Text style={styles.normal}>In John 16, Jesus is telling His followers plainly that He is about to die. Jesus thought it was worth noting that they didn’t care where he was going after he died because their hearts were filled with sorrow. They were probably thinking if Jesus was no longer going to be here in the flesh then nothing can be as good as that. Then Jesus said “It is better that I go away; for if I do not go away, the Helper will not come to you; but if I go, I will send Him to you.”. It is clear here that if Jesus doesn’t ascend he cannot send Holy Spirit. Let’s go back to the tomb…</Text>
            <Text style={styles.normal}>Mary was trying to cling to Jesus even though He said it was better if He went away. Jesus thought it was necessary to tell her to stop clinging to Him. I mean why can’t she just hug Him for a little bit then say He has to go? Was Jesus being insensitive to Mary’s moment? Or was Jesus trying not to delay Mary‘s moment of union with Holy Spirit any longer? If so, was Mary being insensitive to her own moment? Mary knew Jesus was the only salvation she had on this earth. She wanted to cling tightly to that security and safety. Jesus didn’t want her clinging to her salvation but He wanted her to be consumed by the Holy Spirit which was promised. You see mankind had no way to cling onto God before Jesus was on the scene. Jesus knew clinging to His physical body was not the answer and he wanted to relate that to Mary and all the readers of the Bible because He was literally about to unlock the ability for all flesh to be able to cling onto God in the Spirit by the power of Holy Spirit so that they may have access to His presence at all times and be radically transformed by Holy Spirit living on the inside! </Text>
            <Text style={styles.normal}>Jesus was about to fulfill many promises from the Old Testament like Isaiah 44:3-5 where it says “For I will pour out water on the thirsty land And streams on the dry ground; I will pour out My Spirit on your offspring And My blessing on your descendants; And they will spring up among the grass Like poplars by streams of water. This one will say, ‘I am the LORD’s’.” </Text>
            <Text style={styles.normal}>And Joel 2:28 “It will come about after this That I will pour out My Spirit on all mankind; And your sons and daughters will prophesy, Your old men will dream dreams, Your young men will see visions.”</Text>
            ...
            <Text style={styles.normal}>All creation could not be in true relationship with the Father unless Jesus ascended. Restoring mankind to their creator was Jesus‘s main mission and for that mission to be complete, ‘It is better that I go...‘ John 16:7.</Text>
        </>
    )
}
